 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function Tf(e=Zo()){return Sf().then(t=>{if(!t)throw N.create("unsupported-browser")},t=>{throw N.create("indexed-db-unsupported")}),ct(pn(e),"messaging").getImmediate()}async function Xf(e,t){return e=pn(e),Ea(e,t)}function Df(e,t){return e=pn(e),Af(e,t)}If();const Jf=({children:e,breadcrumbs:t,...n})=>{const r=fe(),o=r.props.flash,a=r.props.firebase,[s,c]=u.useState(null),l=/iPad|iPhone|iPod/.test(navigator.userAgent)&&!window.MSStream,f=window.matchMedia("(display-mode: standalone)").matches||window.navigator.standalone,d=!l||l&&f;return u.useEffect(()=>{if(!(!(a!=null&&a.apiKey)||!(a!=null&&a.projectId))&&d)try{const p=gn(a),g=Tf(p);c(g)}catch(p){console.error("Firebase başlatma hatası:",p)}},[a,d]),u.useEffect(()=>{if(!s||!d)return;const p=Df(s,g=>{var v,b;const h=((v=g.notification)==null?void 0:v.title)||"Yeni Bildirim",m=((b=g.notification)==null?void 0:b.body)||"",y=g.data||{};Se(h,{description:m,action:{label:"Görüntüle",onClick:()=>{y.url?window.location.href=y.url:window.location.href="/notifications"}},duration:8e3,position:"top-right"})});return()=>{p()}},[s]),u.useEffect(()=>{o!=null&&o.success&&Se.success(o.success),o!=null&&o.error&&Se.error(o.error),o!=null&&o.warning&&Se.warning(o.warning),o!=null&&o.info&&Se.info(o.info)},[o]),i.jsx(fl,{children:i.jsx(Nl,{breadcrumbs:t,...n,children:e})})};export{Jf as A,Xf as B,Ja as C,Qa as D,Sf as E,Df as F,Yf as G,$s as I,Tn as M,Xa as O,Ya as P,Wa as R,Tt as S,qa as T,Ff as W,vs as X,es as a,Za as b,ws as c,Lf as d,_s as e,Cs as f,Es as g,Is as h,$f as i,Tr as j,Ps as k,Dn as l,An as m,Kf as n,Gf as o,Vf as p,zf as q,mo as r,bo as s,vo as t,pl as u,Uf as v,an as w,cn as x,rs as y,Tf as z};
