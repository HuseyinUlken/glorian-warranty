...
const getBreadcrumbs = (user: User): BreadcrumbItem[] => [
    ...
    {
        title: user.name,
        href: route('user_management.show', user.id),
    },
    {
        title: 'Düzenle',
...
export default function EditUser({ user, roles, userRoles }: EditUserProps) {
    ...
    const handleSubmit = (e: React.FormEvent) => {
        e.preventDefault();
        post(route('user_management.update', user.id), {
            forceFormData: true,
        });
    };
        ...
        <AppLayout breadcrumbs={getBreadcrumbs(user)}>
            ...
            <div className="flex h-full flex-1 flex-col gap-4 rounded-xl p-4">
                <Heading
                    ...
                    description="Kullanıcı bilgilerini düzenlemek için bu formu kullanabilirsiniz."
                    buttons={
                        <div className="flex gap-2">
                            <PermissionGuard permissions={[Permissions.userManagement.view]}>
                                <Link href={route('user_management.show', user.id)}>
                    ...
                    <div className="grid grid-cols-1 gap-6 md:grid-cols-3">
                        ...
                        <Card className="md:col-span-2">
                            ...
                            <CardContent className="space-y-4">
                                ...
                                <div className="space-y-2">
                                    <Label htmlFor="password">Şifre (Değiştirmek istemiyorsanız boş bırakın)</Label>
                                    <Input
                                        id="password"
                                        type="password"
                                        value={data.password}
