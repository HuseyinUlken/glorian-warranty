        ...
        <AppLayout breadcrumbs={breadcrumbs}>
            ...
            <SettingsLayout>
                <div className="space-y-6">
                    <HeadingSmall
                        title="Parola Ayarları"
                        description="Hesabınıza güvenli bir şekilde kalbilek için uzun, rastgele bir parola kullanın"
                    />
                    ...
                    <form onSubmit={updatePassword} className="space-y-6">
                        ...
                        <div className="grid gap-2">
                            <Label htmlFor="password_confirmation">Parola Onayı</Label>
                        ...
                        <div className="flex items-center gap-4">
                            <Button disabled={processing}>Parolayı Kaydet</Button>
