...
export default function EditProduct({ product, categoryOptions }: EditProductProps) {
        ...
        <AppLayout breadcrumbs={getBreadcrumbs(product)}>
            ...
            <div className="flex h-full flex-1 flex-col gap-4 rounded-xl p-4">
                <Heading
                    ...
                    description="Ürün bilgilerini düzenlemek için bu formu kullanabilirsiniz."
                    buttons={
                                ...
                                <CardContent className="space-y-4">
                                    <div className="space-y-3">
                                        ...
                                        <div className="text-sm">
                                            <div className="font-medium">Garanti Süresi:</div>
                                            <div className="text-muted-foreground">{product.formatted_warranty_duration}</div>
                                        </div>
                                        
                                        <div className="text-sm">
                                            <div className="font-medium">Kullanım Sayısı:</div>
                                            <div className="text-muted-foreground">{product.services_count} hizmet</div>
                                        </div>
