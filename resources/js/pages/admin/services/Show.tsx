...
import { ArrowLeft, Calendar, Car, Pencil, Shield, User } from 'lucide-react';
...
interface AdminServiceShowProps extends PageProps {
    service: Service;
}
...
export default function AdminServiceShow({ service }: AdminServiceShowProps) {
    return (
                ...
                <div className="grid grid-cols-1 gap-6 md:grid-cols-3">
                    ...
                    <Card className="md:col-span-2">
                        ...
                        <CardContent className="space-y-4">
                            ...
                            {service.dealer && (
                                <div>
                                    <h3 className="text-sm font-medium text-zinc-500">Bayi</h3>
                                    <div className="mt-1 flex items-center">
                            ...
                            {service.warranty.start_date && (
                                <div>
                                    <h3 className="text-sm font-medium text-zinc-500">Garanti Başlangıcı</h3>
                                    <div className="mt-1 flex items-center">
                                        <Shield className="mr-2 h-4 w-4 text-zinc-400" />
                                        <span>{service.warranty.start_date}</span>
                                    </div>
                                </div>
                            )}
                        </CardContent>
                            ...
                            <CardContent className="space-y-4">
                                <div className="text-center p-4 bg-blue-50 rounded-lg">
                                    <div className="text-2xl font-bold text-blue-600">
                                        {service.applied_products_count}
                                    </div>
