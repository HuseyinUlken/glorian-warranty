        ...
        <AnimatePresence>
          {!isDismissed && (
            <motion.div
              ...
              className={cn("group rounded-lg border bg-white dark:bg-zinc-800 p-3", className)}
  ...
  return (
    ...
    >
      ...
      >
              ...
              >
                {type === "video" ? (
                  <video
                    src={src}
                    className={cn(
                      "w-full rounded-md border border-zinc-200 dark:border-zinc-700 object-cover shadow-lg",
                      itemClassName
                    )}
        ...
        <motion.div
          className="absolute right-0 bottom-0 left-0 h-10 bg-gradient-to-b from-transparent to-white dark:to-zinc-800"
